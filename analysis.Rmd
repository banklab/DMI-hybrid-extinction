...
```{r figure survival probability for unlinked loci as a function of epistasis, fig.height=6, fig.width=8, height=6, width=8}
...
```{r Figure link between recombination minimum pop size and hybrid speciation for the codominant case with epistasis -0.2 and an initial population size of 5000 extra precision}
...
```{r Figure survival probability and hybrid speciation as a function of recombination for the case with epistasis -0.2 and an intial population size of 5000 extra precision version 2}
